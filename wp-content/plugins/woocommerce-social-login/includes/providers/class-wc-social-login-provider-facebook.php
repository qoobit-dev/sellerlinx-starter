...
class WC_Social_Login_Provider_Facebook extends WC_Social_Login_Provider {
	...
	public function get_description() {
		...
		return sprintf( __( 'Need help setting up and configuring Facebook? %1$sRead the docs%2$s', 'woocommerce-social-login' ), '<a href="http://docs.woothemes.com/document/woocommerce-social-login-create-social-apps#facebook">', '</a>' );
	}
