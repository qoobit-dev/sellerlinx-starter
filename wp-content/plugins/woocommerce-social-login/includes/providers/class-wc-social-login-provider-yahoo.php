...
class WC_Social_Login_Provider_Yahoo extends WC_Social_Login_Provider {
	...
	public function get_description() {
		...
		return sprintf( __( 'Need help setting up and configuring Yahoo? %1$sRead the docs%2$s', 'woocommerce-social-login' ), '<a href="http://docs.woothemes.com/document/woocommerce-social-login-create-social-apps#yahoo">', '</a>' );
	}
